...
export class DonateForm {
  ...
  constructor(totalAmount, createNewDonate, minDonate, maxDonate) {
    ...
    this.#maxDonate = maxDonate || DonateForm.DefaultDonateValue.max;
    this.#minDonate = minDonate || DonateForm.DefaultDonateValue.min;
  }
  ...
  #renderDonateButton() {
    ...
    donateButton.textContent = DonateForm.TextObject.DonateButtonText;
